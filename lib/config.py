...
class Config:
    ...
    def __init__(self):
        ...
        # False: Point.z is antenna height above local ground. True: Point.z is
        # absolute antenna altitude after adding terrain ground elevation.
        self.TERRAIN_NODE_Z_IS_ABSOLUTE_ALTITUDE = False
