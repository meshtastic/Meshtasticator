...
RADIO_CALIBRATION_FIELDS = (
    ...
    "CLUTTER_URBAN_LOSS_DB_PER_KM",
    "CLUTTER_SUBURBAN_LOSS_DB_PER_KM",
    "CLUTTER_FOREST_LOSS_DB_PER_KM",
    "CLUTTER_OPEN_LOSS_DB_PER_KM",
    "CLUTTER_WATER_LOSS_DB_PER_KM",
    "CLUTTER_URBAN_ENDPOINT_LOSS_DB",
    "CLUTTER_MAX_LOSS_DB",
)
